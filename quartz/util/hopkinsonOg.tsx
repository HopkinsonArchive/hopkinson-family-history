...
import type { SocialImageOptions, UserOpts } from "./imageHelper"
 ...
 */
export const hopkinsonOg: SocialImageOptions["imageStructure"] = (
  ...
  return (
    ...
    >
      <div style={{
        position: "absolute", inset: "24px", display: "flex",
        border: "2px solid rgba(102,134,139,.55)", borderRadius: "28px",
      }} />
      <div style={{
        position: "absolute", inset: "38px", display: "flex",
        border: "1px solid rgba(196,166,106,.28)", borderRadius: "22px",
      }} />

      <svg width="455" height="630" viewBox="0 0 455 630"
        style={{ position: "absolute", left: 0, top: 0 }}>
        <g fill="none" stroke="#66868b" stroke-width="3" opacity=".9">
        ...
        {nodes.map(([cx, cy, r], index) => (
          <circle
            ...
            stroke="#e7e0cf" stroke-width="2"
          />
        ))}
      </svg>

      <div style={{
        position: "absolute", right: "36px", top: "80px",
        width: "370px", height: "470px", display: "flex", opacity: .32,
        backgroundImage:
      ...
      <div style={{
        position: "absolute", left: "452px", top: "95px",
        width: "10px", height: "410px", display: "flex",
        borderRadius: "5px", backgroundColor: "#c4a66a",
      }} />

      <div style={{
        position: "absolute", left: "500px", top: "92px",
        display: "flex", padding: "9px 22px",
        border: "1px solid rgba(137,174,178,.55)",
        borderRadius: "18px", backgroundColor: "#1c2b2f",
        color: "#89aeb2", fontSize: "18px", fontWeight: 700,
        letterSpacing: "1.5px",
      }}>
      ...
      <div style={{
        ...
        <div style={{
          display: "flex", color: "#e7e0cf",
          fontFamily: fonts[0].name, fontSize: `${titleSize}px`,
          fontWeight: 700, lineHeight: 1.08, letterSpacing: "-1px",
        }}>
          {displayTitle}
        </div>

        <div style={{
          display: "flex", marginTop: "28px", maxWidth: "590px",
          color: "#a9b0ab", fontSize: "29px", lineHeight: 1.38,
          lineClamp: 3,
        }}>
          {displayDescription}
        </div>
        ...
        <div style={{
          display: "flex", marginTop: "34px", paddingTop: "24px",
          borderTop: "2px solid rgba(137,174,178,.45)",
          color: "#89aeb2", fontSize: "20px",
        }}>
